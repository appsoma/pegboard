...
class Bridge:
	...
	def masterUpdate(self):
		...
		result = json.loads(urllib2.urlopen(urlparse.urlparse(master_url+update_url)).read())
...
class CommandManager:
	...
	def install(self):
		...
		if self._args.marathon:
			...
			content = json.loads(urllib2.urlopen(urlparse.urlparse(marathon_url+callback_url),data={}).read())
